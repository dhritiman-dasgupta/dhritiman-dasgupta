...
| **[hotword-training-service](https://github.com/dhritiman-dasgupta/hotword-training-service)** | The training half of the pair: `POST /train {"wake_word": "…"}` and get back a portable openWakeWord ONNX. Positives are synthesised with Piper across 904 LibriTTS speakers plus F5-TTS, then roughened with reverb and noise before GPU training. |
